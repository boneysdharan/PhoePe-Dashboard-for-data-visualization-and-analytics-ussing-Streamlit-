...
#st.title("Top Transaction Data - State-wise (India Map)")
...
top_10_df = (
    Top_Trans_state.groupby("State")["Transaction_count"]
    .sum()
    .reset_index()
...
# Show Data Preview
"""
if st.checkbox("Show Raw Data", key="raw_data_top_trans_top10"):
...
# Show Data Preview
"""
if st.checkbox("Show Raw Data", key="raw_data_top_trans_bottom10"):
    st.subheader("Bottom 10 States by transaction Count")
    st.dataframe(bottom_10_df)
"""
# Load GeoJSON data from URL
# Plotting Total Transaction Count by State
state_summary = (
    Top_Trans_state
...
Top_Trans_fig.update_geos(fitbounds="locations", visible=False)
