...
#st.title("Top Insurance Data - State-wise (India Map)")
...
top_10_df = (
    Top_Insu_state.groupby("State")["Insurance_count"]
    .sum()
    .reset_index()
...
# Show Data Preview
"""
if st.checkbox("Show Raw Data", key="raw_data_top_insu_top10"):
...
# Show Data Preview
"""
if st.checkbox("Show Raw Data", key="raw_data_top_insu_bottom10"):
    st.subheader("bottom 10 States by Insurance Count")
...
Top_Insu_fig.update_geos(fitbounds="locations", visible=False)

# Display in Streamlit
#st.plotly_chart(Top_Insu_fig, use_container_width=True)
